...
SCENARIOS = {
    ...
    "prompt-layer-safeguard": lambda: {
        ...
        "missing_prompt_assets": [
            ...
            ".github/prompts/cells-explore.prompt.md",
            ".github/prompts/cells-propose.prompt.md",
            ".github/prompts/cells-spec.prompt.md",
            ".github/prompts/cells-design.prompt.md",
            ".github/prompts/cells-tasks.prompt.md",
            ".github/prompts/cells-apply.prompt.md",
            ".github/prompts/cells-verify.prompt.md",
            ".github/prompts/cells-archive.prompt.md",
