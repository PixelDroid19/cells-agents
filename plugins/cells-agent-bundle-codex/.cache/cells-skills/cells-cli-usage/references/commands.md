...
- **Details**:
    ...
    - Outputs the merged demo/runtime bundle to `/demo/locales`.
    - This command does not prove that every repo uses `demo/locales` as the only locale source for every surface.
