...
WORKFLOW:
1. Launch cells-explore sub-agent to investigate the codebase for this change
2. Present the exploration summary to the user
3. Launch cells-propose sub-agent to create a proposal based on the exploration
