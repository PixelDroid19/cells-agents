...
REQUIRED_FILES = [
    ...
    ".github/prompts/sdd-explore.md",
    ".github/prompts/sdd-propose.md",
    ".github/prompts/sdd-spec.md",
    ".github/prompts/sdd-design.md",
    ".github/prompts/sdd-tasks.md",
    ".github/prompts/sdd-apply.md",
    ".github/prompts/sdd-verify.md",
    ".github/prompts/sdd-archive.md",
    ".github/prompts/sdd-fallback.md",
